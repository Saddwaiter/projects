...
function ProductScreen() {
  ...
  const addToCartHandler = async () => {
    ...
    if (data.countInStock < quantity) {
      window.alert('Вибач. Товару немає в наявності');
      return;
    }
    ctxDispatch({
      type: 'CART_ADD_ITEM',
                  ...
                  <Row>
                    ...
                    <Col>
                      {product.countInStock > 0 ? (
                        <Badge bg="success">Доступний на складі</Badge>
                      ) : (
                        <Badge bg="danger">Недоступний</Badge>
                      )}
                    </Col>
                  </Row>
                </ListGroup.Item>
      ...
      <div className="my-3">
        ...
        <div className="mb-3">
          {product.reviews.length === 0 && (
            <MessageBox>Ще немає коментарів</MessageBox>
          )}
        </div>
        <ListGroup>
            ...
            <form onSubmit={submitHandler}>
              ...
              <Form.Group className="mb-3" controlId="rating">
                ...
                >
                  ...
                  <option value="4">4- Дообре</option>
